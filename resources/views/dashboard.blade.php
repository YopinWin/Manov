...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;600&family=Cormorant+Garamond:italic,wght@500;700&display=swap"
        rel="stylesheet">
    ...
    <div class="flex min-h-screen">
        ...
        <aside id="main-sidebar" class="w-72 bg-white border-r border-pink-100 flex flex-col sticky top-0 h-screen">
            ...
            <nav class="flex-1 px-4 space-y-2">
                ...
                <button onclick="showTab('dashboard', this)"
                    class="tab-btn w-full flex items-center px-4 py-3 bg-pink-50 text-pink-600 rounded-2xl font-bold">
                    <i class="fa-solid fa-house-chimney w-8"></i> Dashboard
                </button>

                <button onclick="showTab('energy', this)"
                    class="tab-btn w-full flex items-center px-4 py-3 text-gray-400 hover:bg-pink-50 rounded-2xl">
                    <i class="fa-solid fa-bolt-lightning w-8"></i> Energy Flow
                </button>

                <button onclick="showTab('mood', this)"
                    class="tab-btn w-full flex items-center px-4 py-3 text-gray-400 hover:bg-pink-50 rounded-2xl">
                    <i class="fa-solid fa-face-smile w-8"></i> Mood-Check AI
                </button>

                <button onclick="showTab('meal', this)"
                    class="tab-btn w-full flex items-center px-4 py-3 text-gray-400 hover:bg-pink-50 rounded-2xl">
                    <i class="fa-solid fa-utensils w-8"></i> Smart Meal
                </button>

                <button onclick="showTab('academic', this)"
                    class="tab-btn w-full flex items-center px-4 py-3 text-gray-400 hover:bg-pink-50 rounded-2xl">
                    <i class="fa-solid fa-chart-line w-8"></i> Academic Stats
                </button>

                <!-- ✅ FIX: DARI REDIRECT JADI TAB -->
        ...
        <main class="flex-1 flex flex-col min-h-screen p-10">
            ...
            <header class="flex justify-between items-center mb-10">
                ...
                <div class="flex items-center gap-4">
                    <button id="sidebar-toggle"
                        class="w-10 h-10 flex items-center justify-center bg-white border border-pink-100 rounded-xl hover:bg-pink-50">
                ...
                <div class="flex items-center gap-3 bg-white px-4 py-2 rounded-full border">
                    <div
                        class="w-8 h-8 bg-pink-200 rounded-full flex items-center justify-center text-pink-600 font-bold">
            ...
            <div class="w-full max-w-5xl mx-auto flex-1">
                ...
                <!-- ✅ TAMBAHAN ABOUT -->
                <div id="about" class="tab-content">@include('sync-features.about')</div>

                <!-- FOOTER -->
                <footer class="mt-4 pb-8 flex justify-center">
                    <div
                        class="bg-[#FFFDFE] border border-pink-100 rounded-[3rem] px-12 py-10 shadow-sm text-center w-full">
                        ...
                        <div class="flex justify-center gap-10 text-xl text-gray-400 mb-5">
                            <a href="https://www.instagram.com/revalyaaaa" target="_blank">
